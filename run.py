...
def create_composio_toolset(crm: str = "hubspot") -> Toolset:
    ...
    if crm == "hubspot":
        ...
        actions = [
            Action.SALESFORCE_CREATE_LEAD_OBJECT,
            Action.SALESFORCE_CREATE_LEAD_OBJECT_WITH_PROPERTIES,
            Action.SALESFORCE_SEARCH_LEADS_BY_CRITERIA,
            Action.SALESFORCE_CREATE_CONTACT_OBJECT_WITH_PROPERTIES,
            Action.SALESFORCE_CREATE_ACCOUNT_OBJECT,
            Action.SALESFORCE_SEARCH_CONTACTS_BY_CRITERIA,
            Action.SALESFORCE_SEARCH_ACCOUNT_OBJECTS,
            Action.SALESFORCE_SEARCH_ACCOUNT_OBJECTS_BY_CRITERIA,
            Action.SALESFORCE_CREATE_NEW_OPPORTUNITY_OBJECT,
            Action.SALESFORCE_SEARCH_OPPORTUNITIES_BY_CRITERIA,
            Action.SALESFORCE_READ_PROPERTY_GROUPS_FOR_OBJECT_TYPE,
            Action.SALESFORCE_LIST_ASSOCIATION_TYPES,
            Action.SALESFORCE_CREATE_BATCH_OF_OBJECTS,
        ]
    else:
        raise ValueError(f"Unsupported CRM: {crm}")
